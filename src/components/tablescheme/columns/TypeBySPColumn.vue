...
<template>
    <ColumnContainer :width="100">
        ...
        <FeederRow :isselected="selectedFeederId === feeder.id" :isHovered="hoverFeederId === feeder.id"
            ...
            :key="feeder.id">
            <select class="my-select" v-model="feeder.consumer.groupNameBySP">
                <option v-for="option in typesBySP">{{ option }}</option>
            </select>
        </FeederRow>
...
const typesBySP: Array<string> | undefined = inject('typesBySP')
